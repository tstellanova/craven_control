...
const ELECTRODE_SURFACE_MM2:f32 = std::f32::consts::PI*(1.5)*25.; // 1.5 mm diameter, about 25 mm long
...
const NUCLEATION_CURRENT_DENSITY_AMPS_CM2:f32 = 0.04;// Experimental for C2800 twisted cathode
...
const ELONGATION_CURRENT_DENSITY_AMPS_CM2:f32 = 0.4; // Experimental for C2800 twisted cathode
